...
class PerfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post perfils_url, params: { perfil: { f_nac: @perfil.f_nac, sexo: @perfil.sexo, usuario_id: @perfil.usuario_id } }
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { f_nac: @perfil.f_nac, sexo: @perfil.sexo, usuario_id: @perfil.usuario_id } }
